...
public class Map1 {
     ...
     * and set the key "a" to have the value "". Basically "b" is a bully, taking the
    ...
    public Map<String, String> mapShare(Map<String, String> map) {
        map.remove("c");
        if (map.get("a") != null) map.put("b", map.get("a"));
        return map;
    }

    /**
     * Modify and return the given map as follows: for this problem the map may or may not
     * contain the "a" and "b" keys. If both keys are present, append their 2 string
    ...
    public Map<String, String> mapAB3(Map<String, String> map) {
        if (map.get("a") == null && map.containsKey("b")) map.put("a", map.get("b"));
        if (map.get("b") == null && map.containsKey("a")) map.put("b", map.get("a"));
        return map;
    }
