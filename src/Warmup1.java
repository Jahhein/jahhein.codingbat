...
/**
 * Created by jahhein on 6/11/15 at 8:13 AM. Project: codingbat. * Copyright © 2015-2016. Jacob Alan Hein. All Rights
...
public class Warmup1 {
   ...
   * n will be a valid index of a char in the original string (i.e. n will be in the range 0..str.length()-1
   * inclusive).
   *
   * @param str
   * @param n
  ...
  public String startOz(String str) {
    if (str.length() == 0 || str.charAt(1) != 'z')
      return "";
    else if (str.length() == 1 && str.charAt(0) == 'o' || str.charAt(0) == 'o')
      return "o";
